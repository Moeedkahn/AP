...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Product=mTablayout.newTab();
        Wishlist=mTablayout.newTab();
        Cart=mTablayout.newTab();
        Contact=mTablayout.newTab();
        Product.setIcon(R.drawable.home);
        Product.setText("Home");
        Wishlist.setIcon(R.drawable.wishlist);
        ...
        mTablayout.addTab(Product);
        mTablayout.addTab(Wishlist);
        mTablayout.addTab(Cart);
        mTablayout.addTab(Contact);
